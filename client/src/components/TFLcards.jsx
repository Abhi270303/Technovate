...
import AWSImg from '../img/down_arrow.svg'
//import FreeImg from '../img/free_img.png'
import IBMImg from '../img/down_arrow.svg'
import GoogleImg from '../img/down_arrow.svg'
import MicrosoftImg from '../img/down_arrow.svg'
      ...
      <div className="p-9 h-full">
        ...
        <div className="h-full w-full grid md:grid-cols-3 gap-6 my-6 md:px-16">
          {visiblePosts.map(post => (
            ...
            <div key={post.id} className=" md:w-375 p-8 min-w-260 bg-lightCard backdrop-blur-md rounded-3xl flex flex-col justify-center drop-shadow-lg gap-4 hover:scale-105 transition-all duration-300 border">
